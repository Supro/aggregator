Aggregator.PublicationSourceFormMixin = Ember.Mixin.create({
  ...
  setSource: function(source){
    var action_fields = [];
    action_fields.push({key: "source_id", value: source.get('id')});
    action_fields.push({key: "url", value: this.get('model.url')});
  ...
  actions: {
    removeSource: function(){
      var action_fields = [];
      action_fields.push({key: "source_id", value: "null"});
      action_fields.push({key: "url", value: ""});
      var hash = {name: 'update', user_id: this.get('session.currentUser.id'), action_fields: action_fields};
